...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <img class="screenshot-width-832" src="<%= Url.Content("~/content/img/editor/comment.png") %>" alt="" />
    ...
    <img class="screenshot-width-832" alt="Commenting" src="<%= Url.Content("~/content/img/editor/commenting.png") %>" />
    <p>
...
reply2
            ...
            <img class="screenshot-width-832" src="<%= Url.Content("~/content/img/editor/comments-threaded.png") %>" alt="" />
        </li>
        <li>
