...
&lt;/script&gt;
            ...
            <img class="screenshot-width-832" alt="Embed docxf" src="<%= Url.Content("~/content/img/editor/embed-docxf.png") %>" />
        </div>
...
&lt;/script&gt;
            ...
            <img class="screenshot-width-832" alt="Embed oform" src="<%= Url.Content("~/content/img/editor/embed-oform.png") %>" />
        </div>
    </div>
