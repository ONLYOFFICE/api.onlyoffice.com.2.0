...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <img class="screenshot-width-832" src="<%= Url.Content("~/content/img/editor/review.png") %>" alt="" />
    ...
    <img class="screenshot-width-832" alt="Reviewing" src="<%= Url.Content("~/content/img/editor/accept_reject.png") %>" />
    <p>
