    ...
    <pre>
{
    ...
    <img class="screenshot-width-832" alt="Plugin folder" src="<%= Url.Content("~/content/img/desktop/plugins_folder.png") %>" />
    ...
    <img class="screenshot-width-832" alt="Extended comments" src="<%= Url.Content("~/content/img/desktop/extended_comments.png") %>" />
