...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div id="windows" class="content active">
            ...
            <p><img class="screenshot-width-300" alt="Windows shortcut" src="<%= Url.Content("~/content/img/desktop/windows-shortcut.png") %>" /></p>
            ...
            <ol>
                ...
                <li>
                    ...
                    <p><img class="screenshot-width-300" alt="Windows terminal" src="<%= Url.Content("~/content/img/desktop/windows-terminal.png") %>" /></p>
                </li>
        ...
        <div id="macos" class="content">
            ...
            <ol>
                ...
                <li>
                    ...
                    <p><img class="screenshot-width-550" alt="MacOS terminal" src="<%= Url.Content("~/content/img/desktop/macos-terminal.png") %>" /></p>
                </li>
    ...
    <p><img class="screenshot-width-832" alt="Debug" src="<%= Url.Content("~/content/img/desktop/debugging.png") %>" /></p>
