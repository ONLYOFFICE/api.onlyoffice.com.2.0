...
<ol>
    <li>
        ...
        <img class="screenshot-width-832" alt="Connection list" src="<%= Url.Content("~/content/img/desktop/connection_list.png") %>" />
    </li>
    <li>
        ...
        <img class="screenshot-width-832" alt="Provider button" src="<%= Url.Content("~/content/img/desktop/provider_button.png") %>" />
    </li>
</ol>
