...
<ol>
    ...
    <li>
        ...
        <img class="screenshot-width-832" alt="New folder" src="<%= Url.Content("~/content/img/plugins/new-folder.png") %>" />
    </li>
    <li>
    ...
    <div class="content active">
        ...
        <ol>
            ...
            <li>
                ...
                <img class="screenshot-width-832" alt="Chrome developer mode" src="<%= Url.Content("~/content/img/plugins/chrome-developer-mode.png") %>" />
            </li>
            <li>
                <p>Select the created main extension folder:</p>
                <img class="screenshot-width-832" alt="Chrome extension folder" src="<%= Url.Content("~/content/img/plugins/chrome-extension-folder.png") %>" />
            </li>
            <li>
                <p>The new extension is now available in your browser:</p>
                <img class="screenshot-width-832" alt="Chrome extension" src="<%= Url.Content("~/content/img/plugins/chrome-extension.png") %>" />
            </li>
            <li>
                <p>Launch ONLYOFFICE Cloud and open any document to check if the new plugin is available in the editors:</p>
                <img class="screenshot-width-832" alt="Hello world icon" src="<%= Url.Content("~/content/img/plugins/helloworld_icon.png") %>" />
            </li>
        </ol>
        <br />
        ...
        <img class="screenshot-width-832" alt="Chrome removing extension" src="<%= Url.Content("~/content/img/plugins/chrome-removing-extension.png") %>" />
    ...
    <div class="content">
        ...
        <ol>
            ...
            <li>
                ...
                <img class="screenshot-width-832" alt="Opera extensions" src="<%= Url.Content("~/content/img/plugins/opera-extensions.png") %>" />
            </li>
            <li>
                <p>Turn on the <b>Developer mode</b> and click the <b>Load unpacked</b> button:</p>
                <img class="screenshot-width-832" alt="Opera develoer mode" src="<%= Url.Content("~/content/img/plugins/opera-developer-mode.png") %>" />
            </li>
            <li>
                <p>Select the created main extension folder:</p>
                <img class="screenshot-width-832" alt="Opera extension folder" src="<%= Url.Content("~/content/img/plugins/opera-extension-folder.png") %>" />
            </li>
            <li>
                <p>The new extension is now available in your browser:</p>
                <img class="screenshot-width-832" alt="Opera extension" src="<%= Url.Content("~/content/img/plugins/opera-extension.png") %>" />
            </li>
            <li>
                <p>Launch ONLYOFFICE Cloud and open any document to check if the new plugin is available in the editors:</p>
        ...
        <img class="screenshot-width-832" alt="Opera disabling extension" src="<%= Url.Content("~/content/img/plugins/opera-disabling-extension.png") %>" />
        ...
        <ol>
            ...
            <li>
                ...
                <img class="screenshot-width-832" alt="Opera removing extension" src="<%= Url.Content("~/content/img/plugins/opera-removing-extension.png") %>" />
            </li>
        </ol>
        <p>The plugin will be removed from ONLYOFFICE Cloud after page reload.</p>
    </div>
    <div class="content">
        ...
        <ol>
            ...
            <li>
                ...
                <img class="screenshot-width-832" alt="Edge developer mode" src="<%= Url.Content("~/content/img/plugins/edge-developer-mode.png") %>" />
            </li>
            <li>
                <p>Select the created main extension folder:</p>
                <img class="screenshot-width-832" alt="Edge extension folder" src="<%= Url.Content("~/content/img/plugins/edge-extension-folder.png") %>" />
            </li>
            <li>
                <p>The new extension is now available in your browser:</p>
                <img class="screenshot-width-832" alt="Edge extension" src="<%= Url.Content("~/content/img/plugins/edge-extension.png") %>" />
            </li>
            <li>
                <p>Launch ONLYOFFICE Cloud and open any document to check if the new plugin is available in the editors:</p>
                <img class="screenshot-width-832" lt="Hello world icon" src="<%= Url.Content("~/content/img/plugins/helloworld_icon.png") %>" />
            </li>
        </ol>
        <br />
        ...
        <img class="screenshot-width-832" alt="Edge removing extension" src="<%= Url.Content("~/content/img/plugins/edge-removing-extension.png") %>" />
        <p>The plugin will be removed from ONLYOFFICE Cloud after page reload.</p>
    </div>
</div>
