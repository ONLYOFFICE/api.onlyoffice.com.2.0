...
| images.fileType | Defines a type of the image to be inserted into the file. Can be: *bmp*, *gif*, *jpe*, *jpeg*, *jpg*, *png*. Starting from version 8.1, the *tif* / *tiff* extension is also available to be inserted.                                                                          | string           | required |
