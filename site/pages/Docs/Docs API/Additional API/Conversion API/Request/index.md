...
Defines the encrypted signature added to the **ONLYOFFICE Docs** config in the form of a [token](../../Signature/Request/Token%20in%20body/index.md#request-to-convert-the-document).
