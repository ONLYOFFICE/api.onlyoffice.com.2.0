...
import "@onlyoffice/site-kit/client.js"
import "@onlyoffice/ui-kit/client.js"
import {INITIAL_VIEWPORTS, type Viewport, type ViewportMap} from "@storybook/addon-viewport"
import {type Preview, type StoryContext} from "@storybook/preact"
...
function ThemeSwitcher(Story: FunctionComponent, ctx: StoryContext): JSX.Element {
